...
import Userbg from "./../../assets/images/user-grid/user-grid-bg2.png";
import User from "./../../assets/images/user-grid/user-grid-img5.png";
            ...
            <div class="row gy-4">
                <div class="col-lg-4">
                    <div class="user-grid-card position-relative border radius-16 overflow-hidden bg-base h-100">
                        <img src={Userbg} alt="" class="w-100 object-fit-cover"/>
